...
insert into employees values (7001, 'Sandeep', 'Analyst', 25000.00, 10);
insert into employees values (7002, 'Rajesh', 'Designer', 30000.00, 10);
insert into employees values (7003, 'Madhav', 'Developer', 40000.00, 20);
insert into employees values (7004, 'Manoj', 'Developer', 40000.00, 20);
insert into employees values (7005, 'Abhay', 'Designer', 35000.00, 10);
insert into employees values (7006, 'Uma', 'Tester', 30000.00, 30);
insert into employees values (7007, 'Gita', 'Tech. Writer', 30000.00, 40);
insert into employees values (7008, 'Priya', 'Tester', 35000.00, 30);
insert into employees values (7009, 'Nutan', 'Developer', 45000.00, 20);
insert into employees values (7010, 'Smita', 'Analyst', 20000.00, 10);
insert into employees values (7011, 'Anand', 'Project Mgr', 65000.00, 10);

insert into projects values (401, 'Inventory', '2011-04-01', '2011-10-01', '2011-10-31', 150000.00, 1001);
insert into projects values (402, 'Accounting', '2011-08-01', '2012-01-01', null, 500000.00, 1002);
insert into projects values (403, 'Payroll', '2011-10-01', '2011-12-31', null, 75000.00, 1003);
insert into projects values (404, 'Contact Mgmt', '2011-11-01', '2011-12-31', null, 50000.00, 1004);
